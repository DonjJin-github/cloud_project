...
public class awsTest {
    ...
    public static void listImages() {
        ...
        try {
            ...
            for (Image image : result.getImages()) {
                // 이미지 이름이 "aws-htcondor-slave"인 경우만 출력
                if ("aws-htcondor-slave".equals(image.getName())) {
    ...
    public static void executeCondorStatus() {
        ...
        String host = "ec2-3-106-239-186.ap-southeast-2.compute.amazonaws.com";
        String privateKeyPath = "../cloudtest.pem"; // EC2 키 페어 파일 경로 (사용자 환경에 맞게 수정)
